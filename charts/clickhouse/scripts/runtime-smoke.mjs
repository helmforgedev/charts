...
if (version.startsWith('26.8.')) assert.equal(sql("SELECT value FROM system.merge_tree_settings WHERE name='text_index_serialization_version'"), 'v2_with_positions');
