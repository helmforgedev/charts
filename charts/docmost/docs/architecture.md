...
The chart pins the upstream application image through `image.tag` and `appVersion`. For this release, `docmost/docmost:0.96.0` was verified as available on Docker Hub before updating the chart.
