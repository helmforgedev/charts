...
{{- define "immich.valkeyHost" -}}{{- if include "immich.valkeyInternalEnabled" . -}}{{- if eq .Values.valkey.architecture "replication" -}}{{ include "immich.valkeyFullname" . }}-primary{{- else if eq .Values.valkey.architecture "standalone" -}}{{ include "immich.valkeyFullname" . }}-client{{- else -}}{{- fail "Immich internal cache supports valkey.architecture=standalone or replication" -}}{{- end -}}{{- else -}}{{ .Values.valkey.external.host }}{{- end -}}{{- end -}}
