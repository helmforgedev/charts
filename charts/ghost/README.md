...
| `image.tag` | `6.63.0` | Ghost image tag |
...
Ghost `6.63.0` adds Node 24 support, updates the Source theme, and fixes member
preferences, plan-change reporting and tag search. It does not change the image's port, content
